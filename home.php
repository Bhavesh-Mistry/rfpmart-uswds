...
<head>
   ...
   <title>Home Page - RFPMart + USWDS</title>
   <meta name="description" content="Build Government-Ready Websites in Minutes." />
               ...
               <div class="usa-hero__callout maxw-mobile-lg">
                  ...
                  <h1 class="usa-hero__heading margin-top-0">
                     <span class="usa-hero__heading--alt">
                        Build Government-Ready Websites in Minutes
                     </span>
                  </h1>
                  <p>
                     Free, customizable USWDS templates that help agencies, civic tech teams, and creators launch fast, accessible, and compliant websites—without the complexity.
                  </p>
                  <a href="#" class="usa-button">Browse All Templates</a>
               </div>
         </div>
      </section>
            ...
            <div class="grid-row grid-gap-4 padding-1">
               <div class="usa-card desktop:grid-col-5 tablet:grid-col-5 tablet:margin-0">
                  <div class="usa-card__container margin-x-0">
                        <div class="usa-card__header">
                           <h4 class="usa-card__heading">City Government Website Template</h4>
                        </div>
                        <div class="usa-card__media usa-card__media--exdent">
                           <div class="usa-card__img">
                              <img src="images/webp/card-visit-community-life-1.webp" alt="Portrait of Mayor RFP Mart" />
                           </div>
                        </div>
               ...
               <div class="desktop:grid-col-7 tablet:grid-col-7 height-full border-left-1 border-primary-darker bg-primary-lighter">
                  <p class="font-heading-md line-height-serif-6 text-italic text-bold">
                     We Do Beautiful Websites & Apps!
                  </p>
                  <p class="font-heading-xs line-height-serif-6 text-base-dark">
                       Your website is just not another random website because it speaks about your brand identity. In a situation where a well-designed website can get a lot of goodwill, in the same place, a bad website design can ruin all brand no matter how great or accomplished your service is.

                       By choosing to partner with us, you are investing in a seamless fusion of form and function designed to protect and project your professional image. We focus on strategic Cost Reduction and uncompromising Security to safeguard your assets, while prioritizing Client Satisfaction through intuitive design. With our Round-the-Clock support, we ensure your digital storefront remains a powerful, reliable asset that works as hard as you do.
                  </p>
               </div>
            </div>
         </div>
            ...
            <ul class="usa-card-group grid-row grid-gap-2">
               <li class="usa-card tablet:grid-col-6 desktop:grid-col">
                  <div class="usa-card__container">
                     ...
                     <div class="usa-card__header">
                           <h4 class="usa-card__heading">Free & Open Source</h4>
                     </div>
                     <div class="usa-card__body">
                           All templates are 100% free to use, modify, and integrate into your projects—no subscriptions, no licensing fees.
                     </div>
               ...
               <li class="usa-card tablet:grid-col-6 desktop:grid-col">
                  <div class="usa-card__container">
                     ...
                     <div class="usa-card__header">
                           <h4 class="usa-card__heading">Federal-Compliant by Default</h4>
                     </div>
                     <div class="usa-card__body">
                           Built using the official U.S. Web Design System 3.0+, following federal design, accessibility, and performance standards.
                     </div>
                     <!-- <div class="usa-card__footer">
                           <a href="#" class="usa-link display-flex flex-row flex-align-center">
                              Go to Portal
               ...
               <li class="usa-card tablet:grid-col-6 desktop:grid-col">
                  <div class="usa-card__container">
                     ...
                     <div class="usa-card__header">
                           <h4 class="usa-card__heading">Quick & Easy Customization</h4>
                     </div>
                     <div class="usa-card__body">
                           Clean HTML, accessible components, and flexible tokens make it simple for teams of any skill level to personalize pages.
                     </div>
                     <!-- <div class="usa-card__footer">
               ...
               <li class="usa-card tablet:grid-col-6 desktop:grid-col">
                  <div class="usa-card__container">
                     ...
                     <div class="usa-card__header">
                           <h4 class="usa-card__heading">Developer-Friendly Code</h4>
                     </div>
                     <div class="usa-card__body">
                           Lightweight, organized, and well-commented code ensures fast implementation and easy maintenance.
                     </div>
                     <!-- <div class="usa-card__footer">
                           <a href="#" class="usa-link display-flex flex-row flex-align-center">
                              View Schedule
            ...
            <div class="margin-bottom-4 border-bottom-05">
               <h2 class="font-heading-xl margin-top-0">
                  ...
                  <p class="font-heading-md text-base line-height-sans-6">
                     A curated selection of our most popular designs
                  </p>
               </h2>
            </div>
            <div class="grid-row grid-gap-2">
               <div class="tablet:grid-col tablet:margin-0 margin-bottom-2">
                 <div class="position-relative display-flex flex-justify-center flex-align-center width-full radius-lg overflow-hidden">
                     <img src="images/webp/card-visit-nature-outdoors-1.webp" class="width-full height-full display-block " alt="Nature Outdoors" />
                  </div>
               </div>
            
               <div class="tablet:grid-col tablet:margin-0 margin-bottom-2">
                  <div class="position-relative display-flex flex-justify-center flex-align-center width-full radius-lg overflow-hidden">
                     <img src="images/webp/card-visit-culture-heritage-1.webp" class="width-full height-full display-block " alt="Culture Heritage" />
                  </div>
               </div>

               <div class="tablet:grid-col ">
                  <div class="position-relative display-flex flex-justify-center flex-align-center width-full radius-lg overflow-hidden">
                     <img src="images/webp/card-visit-community-life-1.webp" class="width-full height-full display-block " alt="Portrait of Mayor RFP Mart" />
                  </div>
               </div>

               <div class="tablet:grid-col-12">
                  <div class="bg-primary-darker padding-3 radius-lg margin-top-2">
                     <h2 class="font-heading-lg text-white margin-top-0">
                        City Government
                     </h2>
                     <div class="grid-row grid-gap-2">
                        <div class="usa-col tablet:grid-col-5 tablet:margin-bottom-0 margin-bottom-2">
                           <a href="#" class="usa-button width-full margin-x-0">
                              Preview Resident Frontend
                           </a>
                        </div>
                        <div class="usa-col tablet:grid-col-5 tablet:margin-bottom-0 margin-bottom-2">
                           <a href="#" class="usa-button width-full margin-x-0">
                        ...
                        <div class="usa-col tablet:grid-col-2 ">
                           <a href="#" class="usa-button usa-button--secondary width-full margin-x-0 ">
                              Learn more
                           </a>
                        </div>
                     </div>
                  </div>
                  <a href="#" class="usa-button  usa-button--outline margin-top-3 tablet:margin-top-4 width-full margin-x-0 hover:bg-primary-dark hover:text-white">
      ...
      <section class="grid-container usa-section">
         <div class="grid-row grid-gap">
            <div class="tablet:grid-col-4">
               ...
               <p>
                  Experience a streamlined, four-step journey to go live quickly without sacrificing your creative vision.
            ...
            <div class="tablet:grid-col-8 usa-prose">
               <ol class="usa-process-list">
                  <li class="usa-process-list__item">
                        <h4 class="usa-process-list__heading">Browse Templates</h4>
                        <p class="margin-top-05">
                           Find the layout that fits your agency or project.
                        </p>
                  </li>
                  <li class="usa-process-list__item">
                        <h4 class="usa-process-list__heading">Download Instantly</h4>
                        <p>
                           Grab the code from our site — no sign-up required.
                        </p>
                  </li>
                  <li class="usa-process-list__item">
                        <h4 class="usa-process-list__heading">Customize</h4>
                        <p>
                          Edit text, components, colors, and USWDS tokens to match your identity.
                        </p>
                  </li>
                  <li class="usa-process-list__item">
                        <h4 class="usa-process-list__heading">Deploy Anywhere</h4>
                        <p>
                           Host on GitHub Pages, cloud platforms, internal servers, or your preferred CMS.
                        </p>
                  </li>
               </ol>
            </div>
